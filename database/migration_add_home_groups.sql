-- Migration: Add Home Groups
-- Safely adds missing home groups without affecting existing data
-- Uses ON CONFLICT to skip groups that already exist
-- Date: 2024

-- Ensure home_groups table exists
...
-- Insert home groups (will skip if already exists)
...
-- Verify insertion
SELECT COUNT(*) as total_home_groups FROM home_groups;