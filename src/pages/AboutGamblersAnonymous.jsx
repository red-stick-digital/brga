...
const AboutGamblersAnonymous = () => {
    // SEO data for About Gamblers Anonymous page
    const seoData = {
        title: "About Gamblers Anonymous | Baton Rouge GA Fellowship",
        description: "Learn about the principles and purpose of Gamblers Anonymous. Baton Rouge GA offers a welcoming fellowship for those seeking recovery from problem gambling.",
        canonicalUrl: "/aboutgamblersanonymous",
        keywords: [
            "about gamblers anonymous",
            "GA fellowship",
            ...
            "12 step gambling program"
        ],
        structuredData: {
            "@context": "https://schema.org",
            "@type": "Organization",
            "name": "Baton Rouge Gamblers Anonymous",
            "url": "https://batonrougega.org/aboutgamblersanonymous",
