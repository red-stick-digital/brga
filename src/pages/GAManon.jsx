...
const GAManon = () => {
    ...
    const seoData = {
        ...
        canonicalUrl: "/gamanon",
        keywords: [
            "gam-anon",
            "family gambling support",
            "help for gamblers family",
            "gambling addiction family",
            "support for problem gambling",
            "loved ones of gamblers",
            "gam-anon meetings baton rouge",
            "gambling family recovery"
        ],
        structuredData: {
            "@context": "https://schema.org",
            "@type": "Organization",
            "name": "Gam-Anon Baton Rouge",
            "description": "Support group for family and friends of problem gamblers",
            "url": "https://batonrougega.org/gamanon",
            "event": {
                "@type": "Event",
                "name": "Gam-Anon Weekly Meeting",
                ...
                "description": "Weekly support meeting for family and friends of problem gamblers"
            }
        }
    };
